...
export default function AdvancedAnalyticsApp() {
  ...
  const commercialChartRows = [
    { line: 'TP1 accepted', revenue: commercial.acceptedRevenue, cost: 0, contribution: commercial.acceptedRevenue },
  ...
  const revenueMixRows = [
    { name: 'TP1', value: commercial.acceptedRevenue },
  ...
  const funnelVisualRows = [
    ...
    { stage: 'Valid', volume: core.valid, conversion: pctValue(ratio(core.valid, core.fetched)) },
    { stage: 'Delivered', volume: core.delivered, conversion: pctValue(ratio(core.delivered, core.valid || core.fetched)) },
    { stage: 'Accepted', volume: core.accepted, conversion: pctValue(ratio(core.accepted, core.delivered || core.fetched)) },
    { stage: 'Answered', volume: core.answered, conversion: pctValue(ratio(core.answered, core.dialed || core.accepted)) },
    { stage: 'RPC', volume: core.rpc, conversion: pctValue(ratio(core.rpc, core.answered || core.dialed)) },
    { stage: 'Sales', volume: core.sales, conversion: pctValue(ratio(core.sales, core.rpc || core.accepted)) },
    { stage: 'Activated', volume: core.activations, conversion: pctValue(ratio(core.activations, core.sales || core.accepted)) }
  ];
  const conversionVisualRows = [
    { metric: 'Valid / Fetched', rate: pctValue(ratio(core.valid, core.fetched)), leakage: pctValue(1 - ratio(core.valid, core.fetched)) },
    { metric: 'Delivered / Valid', rate: pctValue(ratio(core.delivered, core.valid || core.fetched)), leakage: pctValue(1 - ratio(core.delivered, core.valid || core.fetched)) },
    { metric: 'Accepted / Delivered', rate: pctValue(ratio(core.accepted, core.delivered || core.fetched)), leakage: pctValue(1 - ratio(core.accepted, core.delivered || core.fetched)) },
    { metric: 'Answered / Dialled', rate: pctValue(ratio(core.answered, core.dialed || core.accepted)), leakage: pctValue(1 - ratio(core.answered, core.dialed || core.accepted)) },
    { metric: 'RPC / Answered', rate: pctValue(ratio(core.rpc, core.answered || core.dialed)), leakage: pctValue(1 - ratio(core.rpc, core.answered || core.dialed)) },
    { metric: 'Activated / Sales', rate: pctValue(ratio(core.activations, core.sales || core.accepted)), leakage: pctValue(1 - ratio(core.activations, core.sales || core.accepted)) }
  ];
  ...
  const vendorRevenueRows = [
    ...
    { vendor: 'TP1', revenue: commercial.acceptedRevenue }
  ];
